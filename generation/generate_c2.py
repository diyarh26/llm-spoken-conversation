"""
C2 (turn-by-turn, single model) generation with Vicuna-13B.
...
multiple turns at once). Each generation is truncated to the first turn, and we record
`multi_turn_emissions` (how often the model ran past one turn).
...
<out-root>/C2-<prompt>/<id>.json. Run in tmux:
    python generation/generate_c2.py --prompt P0 --out-root data/generated_v3
"""
...
from prompts.templates import build_c2, assign_cards                      # noqa: E402
