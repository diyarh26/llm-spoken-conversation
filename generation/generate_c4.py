...
structure while adding model identity separation.
...
<out-root>/C4-<prompt>/<id>.json. Run in tmux:
    python generation/generate_c4.py --prompt P0 --out-root data/generated_v3
"""
...
from generation.model_utils import (                                       # noqa: E402
    load_model, generate_turn, looks_like_closing, VICUNA, MISTRAL,
)
...
def main() -> None:
    ...
    for cno in todo:
        ...
        rec = {
            "condition": cond, "architecture": "C4", "prompt_level": args.prompt,
